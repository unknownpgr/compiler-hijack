...
public class HijackParser extends Parser {
	...
	public static final String[] tokenNames = {
		"<INVALID>", "'int'", "'('", "'float'", "')'", "';'", "'{'", "','", "'}'", 
		"OP_UNI_1", "OP_BIN_1", "OP_BIN_2", "'='", "OP_UNI_3", "ID", "INT", "FLOAT", 
	...
	public final SContext s() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__7) | (1L << T__6) | (1L << T__5) | (1L << T__2) | (1L << OP_UNI_1) | (1L << OP_UNI_3) | (1L << ID) | (1L << INT) | (1L << FLOAT))) != 0)) {
				{
				{
				setState(12); code(0);
				}
	...
	private CodeContext code(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(21); ((Function_definitionContext)_localctx).ret_type = type_();
				...
				setState(37); ((Function_definitionContext)_localctx).body = code(10);
				}
				break;
			case 2:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(39); ((Unary_operationContext)_localctx).operator = match(OP_UNI_1);
				setState(40); ((Unary_operationContext)_localctx).operand = code(6);
				}
				break;
			case 3:
				{
				...
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(41); ((Unary_operationContext)_localctx).operator = match(OP_UNI_3);
				setState(42); ((Unary_operationContext)_localctx).operand = code(3);
				}
				break;
			case 4:
				{
			...
			case 7:
				...
				case INT:
					{
					setState(58); type_int();
					}
					break;
				case FLOAT:
					{
					setState(59); type_float();
					}
					break;
				default:
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(66); ((Binary_operationContext)_localctx).operator = match(OP_BIN_1);
						setState(67); ((Binary_operationContext)_localctx).ordR = code(6);
						}
						break;
					case 2:
						{
						...
						setState(69); ((Binary_operationContext)_localctx).operator = match(OP_BIN_2);
						setState(70); ((Binary_operationContext)_localctx).ordR = code(5);
						}
						break;
					case 3:
						{
						...
						setState(72); match(OP_BIN_3);
						setState(73); ((AssignContext)_localctx).rhs = code(3);
						}
						break;
					case 4:
						{
						...
						case 2:
							...
							setState(85);
							_la = _input.LA(1);
							if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__7) | (1L << T__6) | (1L << T__5) | (1L << T__2) | (1L << OP_UNI_1) | (1L << OP_UNI_3) | (1L << ID) | (1L << INT) | (1L << FLOAT))) != 0)) {
								{
								setState(77); code(0);
								setState(82);
								_errHandler.sync(this);
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 1: return code_sempred((CodeContext)_localctx, predIndex);
		}
		return true;
	}
	...
	public static final String _serializedATN =
		...
		"\f\3\16\3\67\13\3\3\3\3\3\3\3\3\3\3\3\3\3\5\3?\n\3\3\3\5\3B\n\3\3\3\3"+
		"\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\7\3S\n\3\f\3\16"+
		"\3V\13\3\5\3X\n\3\5\3Z\n\3\3\3\3\3\3\3\7\3_\n\3\f\3\16\3b\13\3\3\4\3\4"+
		"\3\5\3\5\3\6\3\6\3\7\3\7\3\7\2\3\4\b\2\4\6\b\n\f\2\3\4\2\3\3\5\5z\2\21"+
		"\3\2\2\2\4A\3\2\2\2\6c\3\2\2\2\be\3\2\2\2\ng\3\2\2\2\fi\3\2\2\2\16\20"+
